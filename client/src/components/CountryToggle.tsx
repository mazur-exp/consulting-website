  ...
  return (
    <div className="relative" ref={ref}>
      ...
      >
        ...
        <span className="hidden sm:inline">{t(current.nameRu, current.nameEn, current.nameId, current.nameTh)}</span>
        ...
        >
          {COUNTRY_LIST.map((c) => (
            ...
            >
              ...
              <span className="flex-1">{t(c.nameRu, c.nameEn, c.nameId, c.nameTh)}</span>
