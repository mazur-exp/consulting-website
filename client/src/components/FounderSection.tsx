        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-brand-muted text-lg leading-relaxed" data-testid="text-founder-description">
              {t(
                "Основатель IKA Sushi (4 точки на Бали, оборот более 1млрд рупий в месяц), FoodLab (более 8 точек на Бали, оборот более 2млрд рупий в месяц). Опыт работы с маркетплейсами - 8 лет команда делала Android приложения (более 700 приложений было создано), знания в маркетинге и построении бизнесов - за 13 лет было создано 9 успешных бизнесов в разных сферах. Основатель Delivery Booster, сервиса по увеличению продаж на Gojek и Grab: более 100 клиентов, рост продаж в 2-6 раз за счет настройки и оптимизации услуг доставки.",
                "Founder of IKA Sushi (4 locations in Bali, revenue over 1 billion rupees per month), FoodLab (over 8 locations in Bali, revenue over 2 billion rupees per month). Experience with marketplaces - 8 years the team made Android applications (more than 700 applications were created), knowledge in marketing and business building - over 13 years, 9 successful businesses were created in various fields. Founder of Delivery Booster, a service to increase sales on Gojek and Grab: more than 100 clients, sales growth of 2-6 times through setup and optimization of delivery services."
              )}
            </p>
