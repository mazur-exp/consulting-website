...
const THAI_CASES: CaseCard[] = [
  {
    ...
    detailTh: 'ออร์เดอร์ x7.4 · ROAS 24 เท่า · ภายใน 2 เดือน',
  ...
  },
  {
    ...
    nameTh: 'Enjoy Healthy Food (ภูเก็ต)',
    ...
    detailTh: 'ออร์เดอร์ x4.6 · ROAS 27.5 เท่า · ภายใน 14 เดือน',
  ...
  },
  {
    ...
    detailTh: 'ออร์เดอร์ x2.2 · ROAS 34.6 เท่า · ภายใน 2 เดือนช่วงโลว์ซีซัน',
  ...
  },
  {
    ...
    nameTh: 'Meat Point Phuket (ราไวย์)',
    ...
    detailTh: 'ยอดต่อบิล +22% · ROAS 30 เท่า · เติบโตช่วงโลว์ซีซัน',
...
export const COUNTRIES: Record<CountryCode, CountryConfig> = {
  ...
  th: {
    ...
    socialProofTh: 'ร้านอาหารกว่า 15 แห่งในประเทศไทยเติบโตไปกับเรา',
    cases: THAI_CASES,
    caseImages: THAI_CASE_IMAGES,
    clients: [
      'Enjoy Healthy Food',
    ...
    clientsTitleTh: 'ร้านอาหารกว่า 15 แห่งในไทยไว้วางใจเรา',
    showTestimonials: false,
    showVideo: false,
    heroImage: '/th-assets/grab-insights-ehf-sales.jpg',
    heroImageAlt: 'GrabFood sales growth analytics',
