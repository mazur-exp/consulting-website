...
Итоговая версия 24.09 (заголовок выбрал Алекс из трёх: идея «люди думают, что достаточно
включить рекламу»; с абзацами и эмодзи по его просьбе):

🔥 «Включим рекламу, и заказы пойдут». Самая дорогая ошибка владельца ресторана в Grab и Gojek.

Grab и Gojek зарабатывают на комиссии с заказов, а не на показах. Поэтому ставка усиливает позицию карточки, но не создаёт её.

📊 Медиана по 90 ресторанам GrabFood на Бали:

• 7,4% увидевших открывают меню
• 11,5% открывших заказывают
• сквозная конверсия 0,82%, у лучшего 1,85%

Реклама двигает только первую цифру. Остальные две решает карточка.

👉 Сравните свои цифры с медианой и проверьте 5 пунктов до того, как поднимать бюджет: https://booster.delivery/answers/grabfood-ads-not-working
